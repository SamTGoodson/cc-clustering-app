...
app.layout = html.Div([
        ...
        html.P("The New York City Council is overwhelmingly Democratic, which can make discerning the ideological factions of the body difficult. This application takes voting data from the Council's “Legistar” API and clusters members by their voting patterns. Because most council votes are fairly lopsided, this application only looks at the most competitive votes."), 
        html.P("The method of clustering used here is known as “hierarchical clustering.” The graph below is called a “dendrogram” and is used in the process of hierarchical clustering to visualize the clusters and the distance between them. The location on the y-axis determines the numbers of clusters. For example, near the top of the dendrogram, around 140 on the y-axis, there are two lines, which means at this distance there are two clusters. The line on the left leads down to a very small group of individuals at the bottom, these are the council's most conservative members. As you go further down both lines the clusters further subdivide into more specific categories."), 
